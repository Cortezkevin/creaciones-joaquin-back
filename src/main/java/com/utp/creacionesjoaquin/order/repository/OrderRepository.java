...
import com.utp.creacionesjoaquin.sales.dto.dashboard.OrdersCountByStatus;
...
public interface OrderRepository extends JpaRepository<Order, String> {
    ...
    @Query("SELECT NEW com.utp.creacionesjoaquin.sales.dto.dashboard.SalesByMonth(m.month, COALESCE(SUM(o.total), 0))" +
    ...
    @Query("SELECT NEW com.utp.creacionesjoaquin.sales.dto.dashboard.OrdersCountByStatus(o.status, COUNT(o)) FROM Order o GROUP BY o.status")
   ...
   /* @Query("SELECT COALESCE(SUM(o.total), 0) AS total " +
    ...
    @Query("SELECT NEW com.utp.creacionesjoaquin.sales.dto.dashboard.SalesByUser(CONCAT(pi.firstName, ' ', pi.lastName), COUNT(o.id)) " +
            "FROM Order o " +
            "JOIN o.user u " +
